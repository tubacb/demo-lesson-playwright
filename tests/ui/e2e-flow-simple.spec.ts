...
test('login with correct credentials and create order', async ({}) => {
  const orderCreationPage = await authPage.signIn(USERNAME, PASSWORD)
...
test('to show disabled order creation button and username, phone fields input errors and after login with correct credentials and fill the username and phone then clear them', async ({}) => {
  const orderCreationPage = await authPage.signIn(USERNAME, PASSWORD)
...
test('to show phone input error and disabled order creation button after login with correct credentials and fill phone less than 6 characters', async ({}) => {
  const orderCreationPage = await authPage.signIn(USERNAME, PASSWORD)
...
test('to create order after entering correct credentials for login and order pages and to close the popup with OK button and to log out', async ({}) => {
  const orderCreationPage = await authPage.signIn(USERNAME, PASSWORD)
